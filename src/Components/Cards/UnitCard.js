...
export const UnitCard = (data, key) => {
  return (
    <div>
      <div class="card border-0 mb-3 p-0 cardStyle" style={{ width: "100%" }}>
        <Link
          ...
          <div>
            ...
            <div className="card-body text-start cardContentStyle">
              <div className="d-flex justify-content-between">
                <p className="fw-bold m-0">{data.game.title}</p>
              </div>
              <p className="mt-1 mb-0">
                <ul class="nav justify-content-center probsStyle">
                  <li class="nav-item">
                    <span class="nav-link p-2 propsBorderRight">
                      {data.game.team1}:{" "}
                  ...
                  <li class="nav-item ">
                    <span class="nav-link p-2 propsBorderCenter">
                      Empate:{" "}
                  ...
                  <li class="nav-item ">
                    <span class="nav-link p-2 propsBorderLeft">
                      {data.game.team2}:{" "}
